 ...
 *
 * 10.7 适配：central-icons 私有图标 ×12 → lucide-react
 * （落地方案 §6 对照表；Popsicle 无对应 → 品牌 monogram 占位）；
 * GlideMenu → 本地基元（J24 偏差，用户定案）。
 * ───────────────────────────────────────────────────────── */
    ...
    >
      <div className="flex min-h-0 w-[224px] shrink-0 flex-col">
        <div className="relative mb-2.5 h-10 shrink-0">
          ...
          >
            <span className="sidebar-logo flex size-5 shrink-0 items-center justify-center text-[13px] font-bold text-ink">
              G
            </span>
